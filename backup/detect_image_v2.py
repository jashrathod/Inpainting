...
def end_to_end(image_path, DIMINISH_CATEGORY, overlay_type):
    ...
    end_point = img_height, img_width
    img_blur = img
    # img_blur = cv2.rectangle(img_blur, start_point, end_point, BLACK_COLOR, -1)
    # for obj in coordinates:
    #     start_point = obj[0][0], obj[0][1]
    #     end_point = obj[2][0], obj[2][1]
    #     img_blur[start_point[1]:end_point[1]][start_point[0]:end_point[0]
    #                                           ] = dst[start_point[1]:end_point[1]][start_point[0]:end_point[0]]
...
def main2():
    ...
    image_path = "base_image.jpg"
    # image_path = "image.jpg"
    top_left = end_to_end(image_path, DIMINISH_CATEGORY, 'white')
    print(top_left)
